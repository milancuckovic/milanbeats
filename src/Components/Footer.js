            ...
            <div className="row p-2">
                ...
                <h5 className="text-white mb-3">Quick links:</h5>
                    <ul className="list-unstyled text-muted">
                        <li><Link to="/" className="text-decoration-none text-white ho">Home</Link></li>
                        <li><Link to="/about" className="text-decoration-none text-white ho">About</Link></li>
                        <li><Link to="/contact" className="text-decoration-none text-white ho">Contact</Link></li>
                    </ul>
                </div>
                <div className="col-lg-4 col-md-4">
                ...
                <div className="col-lg-4 col-md-4">
                    <div className="d-flex">
                        <img src="./Images/logomilan.svg" className="p-0 m-0" width="80px" height="80px" />
